...
<h2>Crear Nueva Escala de Puntaje</h2>
    ...
    <fieldset>
        <legend>Escala de Puntaje</legend>
         ...
         <!--<div class="editor-label">
            <%: Html.LabelFor(model => model.idEscala) %>
        </div>
        <div class="editor-field">
            <%: Html.EditorFor(model => model.idEscala) %>
            <%: Html.ValidationMessageFor(model => model.idEscala) %>
        </div>-->
